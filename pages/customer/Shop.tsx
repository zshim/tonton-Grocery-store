      ...
      {filteredProducts.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {filteredProducts.map(product => {
            ...
            return (
              <div key={product.id} className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden hover:shadow-md transition-shadow relative group flex flex-col">
                {isDiscounted && (
                ...
                <div className="p-4 flex flex-col flex-1">
                  ...
                  <p className="text-xs text-slate-500 mb-4 line-clamp-2 flex-grow">{product.description}</p>
                  ...
                  <div className="flex items-center justify-between mt-auto pt-2 border-t border-slate-50">
                     ...
                     <div className="flex gap-2">
                       <button 
                        ...
                        className="bg-emerald-600 text-white px-3 py-1.5 rounded-lg text-xs font-bold hover:bg-emerald-700 transition-colors shadow-sm flex items-center gap-1"
                       >
                         <Zap size={14} />
                         Buy Now
                       </button>
                       <button 
                        ...
                        className="bg-emerald-50 text-emerald-700 p-1.5 rounded-lg hover:bg-emerald-600 hover:text-white transition-colors"
                        title="Add to Cart"
                       >
                         <Plus size={20} />
                       </button>
